...
class Backend extends MY_Controller {
        ...
        public function index()
	{
        ...
        function delete_user($id)
        {
            ...
            {
                 $this->session->set_flashdata('message', $this->ion_auth->get_user($id)->username." a été supprimé avec succès");
            }else
            {
                 $this->session->set_flashdata('message', $this->ion_auth->get_user($id)->username." n'a pa pu être supprimé");
            }
            redirect("backend/users_list","refresh");
        }
